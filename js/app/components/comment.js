...
export const comment = (() => {
    ...
    const onNullComment = () => {
        const desc = lang
            ...
            .on('es', '📢 ¡Comparte esta invitación para recibir más comentarios! 🎉')
            .get() ?? '📢 ¡Comparte esta invitación para recibir más comentarios! 🎉';
    ...
    const showMore = (anchor, uuid) => {
        ...
        anchor.innerText = isCollapsed ? 'Ver menos' : 'Ver más';
